...
{
    public partial class NewsSubClass : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                int parentclassid = Convert.ToInt32(Request.QueryString["parentclassid"].ToString());

                NewsClass model = _dataService.GetNewsClassByClassID(parentclassid);
        ...
        {
            int classid = Convert.ToInt32(Request.QueryString["parentclassid"].ToString());
            ...
            if (Request.QueryString["subclassid"] != null)
            {
                ...
                {
                    bc.MessageBox("修改成功！", "NewsSubClass.aspx?parentclassid=" + classid);
                }
                else
                {
                    bc.MessageBox1("修改失败！");
            ...
            else
            {
                ...
                {
                    bc.MessageBox("添加成功！", "NewsSubClass.aspx?parentclassid=" + classid);
                }
                else
                {
                    bc.MessageBox1("添加失败！");
        ...
        protected void BindRepeater()
        {
            ...
            IEnumerable<NewsClass> friendLinks = _dataService.GetSubClasses(parentclassid,3);
