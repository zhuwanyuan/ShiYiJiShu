...
$.fn.formValidator = function(cs) 
{
	...
	//如果为精简模式，tibcss要重新设置初始值
	if(initConfig.tidymode){setting.tibcss = {"left" : "2px","width":"22px","height":"22px","display":"none"}};
	...
	return this.each(function(e)
	{
		...
		if(initConfig.autotip)
		{
			...
			if($("body [id="+tip+"]").length==0)
			{
				...
				$("<div class='formValidateTip'></div>").appendTo($("body")).css({left: x+"px", top: y+"px"}).prepend($('<div id="'+tip+'"></div>').css(setting_temp.tibcss));
			}
