...
{
    public partial class _NewsClass : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (Request.QueryString["classid"] != null)
            {
                ...
                {
                    bc.MessageBox("修改成功！", "NewsClass.aspx?firstclassid=" + firstclassid);
                }
                else
                {
                    bc.MessageBox1("修改失败！");
            ...
            else
            {
                ...
                {
                    bc.MessageBox("添加成功！", "NewsClass.aspx?firstclassid=" + firstclassid);
                }
                else
                {
                    bc.MessageBox1("添加失败！");
        ...
        protected void BindRepeater()
        {
            ...
            IEnumerable<NewsClass> newsclasslist = _dataService.GetSubClasses(firstclassid, 2);
            repClassList.DataSource = newsclasslist;
