<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VideoClass.aspx.cs" Inherits="ShiYiJiShu.web_manage.VideoClass" %>
                ...
                <ItemTemplate>
                    <tr>
                        <td class="td1" align="center">
                            <asp:Label ID="lbLinkID" runat="server" Text='<%#Eval("ClassID") %>'></asp:Label>
                        </td>
                        <td class="td1">
                          <p> <%#Eval("ClassName")%> </p>
                        </td>  
