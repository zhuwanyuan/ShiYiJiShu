<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorList.aspx.cs" Inherits="ShiYiJiShu.web_manage.DoctorList" %>
...
<body>
    <form id="form1" runat="server">
        <div class="right">
            <div class="top">
                <div class="title">
                    <asp:Label ID="title" runat="server" Text="专家委员会"></asp:Label></div>
                <div class="rimg">
            ...
            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                ...
                <ItemTemplate>
                    <tr>
                        <td class="td1" style="height: 85px">
                            <input type="checkbox" name="checkbox" value="<%#Eval("DoctorID")%>" />
                        </td>
                        <td class="td1" align="center">
                            <asp:Label ID="DoctorID" runat="server" Text='<%#Eval("DoctorID") %>'></asp:Label>
                        </td>
                        <td class="td1">
                            <p>
                                <%#CheckShenHe(Eval("ActiveFlag").ToString()) %>&nbsp;<a href="../Doctor/Detail/<%#Eval("DoctorID") %>" target="_blank"><img src='/uploadpic/<%#Eval("DoctorPic")%>' alt="" width="60" /></a> &nbsp;  
                          <a href='../Doctor/Detail/<%#Eval("DoctorID") %>' target="_blank"><%#Eval("DoctorName")%></a> <%#CheckZhiDing(Eval("TuiJian").ToString()) %>
                            </p>
                        </td>
                        ...
                        <td class="td1" align="center">
                            <a href='DoctorAdd.aspx?DoctorID=<%#Eval("DoctorID") %>'>
                                <img src="images/toolbar_edit.gif" alt="修改" style="border: 0" /></a> &nbsp;
                ...
                <AlternatingItemTemplate>
                    <tr>
                        <td class="td2" style="height: 85px">
                            <input type="checkbox" name="checkbox" value="<%#Eval("DoctorID")%>" />
                        </td>
                        ...
                        <td class="td2">
                            <p>
                                <%#CheckShenHe(Eval("ActiveFlag").ToString()) %>&nbsp;<a href="../Doctor/Detail/<%#Eval("DoctorID") %>" target="_blank"><img src='/uploadpic/<%#Eval("DoctorPic")%>' alt="" width="60px" /></a> &nbsp;  
                          <a href='../Doctor/Detail/<%#Eval("DoctorID") %>' target="_blank"><%#Eval("DoctorName")%></a> <%#CheckZhiDing(Eval("TuiJian").ToString()) %>
                            </p>
                        </td>
