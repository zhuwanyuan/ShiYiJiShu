<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsClass.aspx.cs" Inherits="ShiYiJiShu.web_manage._NewsClass" %>
    ...
    <asp:Repeater ID="repClassList" runat="server" OnItemCommand="repClassList_ItemCommand" >
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="td1">
                         <a href="NewsSubClass.aspx?parentclassid=<%#Eval("ClassID") %>">编辑二级类别</a>
                        </td>   
                        <td class="td1" align="center">
                                <a href='NewsClass.aspx?firstclassid=<%#Eval("ParentClassID") %>&classid=<%#Eval("ClassID") %>'><img src="images/toolbar_edit.gif" alt="修改" style="border:0" /></a> &nbsp; <asp:ImageButton ID="ImageButton1" CommandName="delete" runat="server" ImageUrl="images/toolbar_del.gif" OnClientClick="javascript:return confirm('您确定要删除么，删除后不可恢复！');"/>
                        </td>
                    </tr>
                </ItemTemplate>
