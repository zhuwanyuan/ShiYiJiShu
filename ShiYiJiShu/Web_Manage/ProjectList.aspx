<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectList.aspx.cs" Inherits="ShiYiJiShu.web_manage.ProjectList" %>
...
<div class="right">
	<div class="top">
    <div class="title"><asp:Label ID="title" runat="server" Text="项目管理"></asp:Label></div><div class="rimg"><img src="images/admin_12.gif" alt="" /></div>
    </div>
     ...
     <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" >
                ...
                <ItemTemplate>
                    <tr>
                        <td class="td1" style=" height:85px"><input type="checkbox" name="checkbox" value="<%#Eval("ProjectID")%>" /> </td>
                        <td class="td1" align="center">
                            <asp:Label ID="ProjectID" runat="server" Text='<%#Eval("ProjectID") %>'></asp:Label>
                        </td>
                        <td class="td1">
                          <p><%#CheckShenHe(Eval("ActiveFlag").ToString()) %> &nbsp; <a href="../Project/Detail/<%#Eval("ProjectID") %>" target="_blank"><img src='/uploadpic/<%#Eval("ProjectPic")%>' alt="" width="60"  /></a> &nbsp;  
                          <a href='../Project/Detail/<%#Eval("ProjectID") %>' target="_blank"><%#Eval("ProjectName")%></a> &nbsp; <%#CheckTuiJian(Eval("TuiJian").ToString()) %>
                          </p>
                        </td> 
                        <td class="td1" style=" height:85px"> <a href="ProjectRegister.aspx?projectid=<%#Eval("ProjectID") %>">查看报名</a> </td>
                        ...
                        <td class="td1" align="center">
                            <a href='ProjectAdd.aspx?ProjectID=<%#Eval("ProjectID") %>'><img src="images/toolbar_edit.gif" alt="修改" style="border:0" /></a> &nbsp; <asp:ImageButton ID="ImageButton1" CommandName="delete" runat="server" ImageUrl="images/toolbar_del.gif" OnClientClick="javascript:return confirm('您确定要删除么，删除后不可恢复！');"/>
                        </td>
                    </tr>
                </ItemTemplate>
                <AlternatingItemTemplate>
                <tr>
                        <td class="td2" style=" height:85px"><input type="checkbox" name="checkbox" value="<%#Eval("ProjectID")%>" /> </td>
                        ...
                        <td class="td2" style=" height:85px"> <a href="ProjectRegister.aspx?projectid=<%#Eval("ProjectID") %>">查看报名</a> </td>
