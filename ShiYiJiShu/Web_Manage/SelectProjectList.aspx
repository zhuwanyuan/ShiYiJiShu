<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectProjectList.aspx.cs" Inherits="ShiYiJiShu.web_manage.SelectProjectList" %>
     ...
     <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" >
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="td1" align="center">
                            <asp:Label ID="lbProjectId" runat="server" Text='<%#Eval("ProjectId") %>'></asp:Label>
                        </td>
                        <td class="td1">
                          <p><%#CheckShenHe(Eval("ActiveFlag").ToString()) %> &nbsp; <a href="../SelectProject/Detail/<%#Eval("ProjectId") %>" target="_blank"><img src='/uploadpic/<%#Eval("ProjectPic")%>' alt="" width="60"  /></a> &nbsp;  
                          <a href='../SelectProject/Detail/<%#Eval("ProjectId") %>' target="_blank"><%#Eval("ProjectName")%></a> &nbsp; <%#CheckTuiJian(Eval("TuiJian").ToString()) %>
                          </p>
                        </td> 
                        <td class="td1" style=" height:85px"><%#Eval("ProjectCompany")%></td>
                        ...
                        <td class="td1" align="center">
                            <a href='SelectProjectAdd.aspx?ProjectId=<%#Eval("ProjectId") %>'><img src="images/toolbar_edit.gif" alt="修改" style="border:0" /></a> &nbsp; <asp:ImageButton ID="ImageButton1" CommandName="delete" runat="server" ImageUrl="images/toolbar_del.gif" OnClientClick="javascript:return confirm('您确定要删除么，删除后不可恢复！');"/>
                        </td>
                    </tr>
                </ItemTemplate>
                <AlternatingItemTemplate>
                 <tr>
                        ...
                        <td class="td2" style=" height:85px"><%#Eval("ProjectCompany")%></td>
